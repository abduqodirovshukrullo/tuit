...
<?php foreach ($carousels as $carousel): ?>
            <!-- Home Slider Item -->
            <div class="owl-item">
                <div class="home_slider_background" style="background-image:url(<?= '/web/uploads/'.$carousel->image; ?>)"></div>
...
<?php endforeach; ?>
        ...
        <div class="row">
            <div class="col">
                <div class="courses_button trans_200"><a href="<?= \yii\helpers\Url::to(['../site/course']) ?>">view all courses</a></div>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col-lg-7 news_col">
                ...
                <div class="news_post_large_container">
                    <div class="news_post_large">
                        ...
                        <div class="news_post_large_title"><a href="blog_single.html"><?= $actives->title_uz; ?></a></div>
...
<?php foreach ($mains as $main): ?>
                    ...
                    <div class="news_post_small">
                        <div class="news_post_small_title"><a href="blog_single.html"><?= $main->title_uz; ?></a></div>
                        <div class="news_post_meta">
